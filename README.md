...
The official documentation wins. Changes should be reviewed against its generated machine-readable index before publication. Examples must not contain credentials, tokens or connection strings.
