...
APP=hermes-contributions
DOMAIN=${DOMAIN:-hermes-contributions.technoir.cloud}
PORT=80
...
[ "${SKIP_FRESHNESS:-}" = 1 ] && { echo "Refusing to deploy with the freshness check skipped." >&2; exit 1; }
bash -c "$CHECK"
